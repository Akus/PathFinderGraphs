...
//		 XXX: Implement in part 1 of week 1
		...
		for ( int i = 0; i < getNumVertices(); i++) {
			int sumDegree = getNeighbors(i).size() + getInNeighbors(i).size();
			degreeSeqList.add(sumDegree);
			Collections.sort(degreeSeqList, Comparator.reverseOrder());
		}
...
// Akos is testing GraphAdjList:
		GraphAdjList AkosGraphAdjList = new GraphAdjList();
		AkosGraphAdjList.addVertex(); // 0
		AkosGraphAdjList.addVertex(); // 1
		AkosGraphAdjList.addVertex(); // 2
		AkosGraphAdjList.addVertex(); // 3

		AkosGraphAdjList.addEdge(0, 1);
		AkosGraphAdjList.addEdge(0, 2);
		AkosGraphAdjList.addEdge(1, 3);
		AkosGraphAdjList.addEdge(2, 1);
		AkosGraphAdjList.addEdge(2, 3);
		
		System.out.println("\nAkos tests: \n" + AkosGraphAdjList.adjacencyString());
		int targetVertex = 0;
		System.out.println("\nGet two hop neighbors of vertex: " + targetVertex + " These neighbors are two hops away from it: " + AkosGraphAdjList.getDistance2(targetVertex).toString());
		
		// Akos is testing GraphAdjMatrix:
		GraphAdjMatrix AkosGraphAdjMatrix = new GraphAdjMatrix();
		System.out.println("Vertices#: " + AkosGraphAdjMatrix.getNumVertices());
		AkosGraphAdjMatrix.addVertex(); // 0
		System.out.println("Vertices#: " + AkosGraphAdjMatrix.getNumVertices());
		System.out.println("Edge#: " + AkosGraphAdjMatrix.getNumEdges());

		AkosGraphAdjMatrix.addVertex(); // 1
		System.out.println("Vertices#: " + AkosGraphAdjMatrix.getNumVertices());
		System.out.println("Edge#: " + AkosGraphAdjMatrix.getNumEdges());

		AkosGraphAdjMatrix.addVertex(); // 2
		System.out.println("Vertices#: " + AkosGraphAdjMatrix.getNumVertices());
		System.out.println("Edge#: " + AkosGraphAdjMatrix.getNumEdges());

		AkosGraphAdjMatrix.addVertex(); // 3
		System.out.println("Vertices#: " + AkosGraphAdjMatrix.getNumVertices());
		System.out.println("Edge#: " + AkosGraphAdjMatrix.getNumEdges());


		AkosGraphAdjMatrix.addEdge(0, 1);
		System.out.println("Edge#: " + AkosGraphAdjMatrix.getNumEdges());

		AkosGraphAdjMatrix.addEdge(0, 2);
		System.out.println("Edge#: " + AkosGraphAdjMatrix.getNumEdges());

		AkosGraphAdjMatrix.addEdge(1, 3);
		System.out.println("Edge#: " + AkosGraphAdjMatrix.getNumEdges());

		AkosGraphAdjMatrix.addEdge(2, 1);
		System.out.println("Edge#: " + AkosGraphAdjMatrix.getNumEdges());

		AkosGraphAdjMatrix.addEdge(2, 3);
		System.out.println("Edge#: " + AkosGraphAdjMatrix.getNumEdges());

		System.out.println("\nAkos tests: \n" + AkosGraphAdjMatrix.adjacencyString());
		int targetVertex2 = 0;
		
		System.out.println("\nGet two hop neighbors of vertex: " + targetVertex2 + 
				" These neighbors are two hops away from it: " + 
				AkosGraphAdjMatrix.getDistance2(targetVertex2).toString());
		
		
		// Akos is testing degreeSequence:
		
		System.out.println("\nDegree sequence: " + AkosGraphAdjMatrix.degreeSequence());
		System.out.println("\nDegree sequence: " + AkosGraphAdjList.degreeSequence());
